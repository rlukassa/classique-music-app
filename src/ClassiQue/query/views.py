    ...
    if request.method == 'POST':
        ...
        if 'query-audio' in request.FILES:
            ...
            if query_audio.content_type in ['audio/wav', 'audio/mid', 'audio/midi']:
                ...
                responses.append(f"Ini hanyalah halaman placeholder untuk debugging dan menunjukkan bahwa file terupload! <br><br> Audio uploaded successfully: {audio_path}")
            else:
                responses.append("Invalid audio file type.")
        
        # Handle file image jika ada
            ...
            if query_image.content_type in ['image/jpeg', 'image/png']:
                ...
                responses.append(f"Ini hanyalah halaman placeholder untuk debugging dan menunjukkan bahwa file terupload! <br><br> Image uploaded successfully: {image_path}")
            else:
